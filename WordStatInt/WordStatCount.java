...
public class WordStatCount{
    ...
    static BufferedReader wrapReader(String fileName) throws FileNotFoundException, 
    ...
    static BufferedWriter wrapWriter(String fileName) throws FileNotFoundException, 
        UnsupportedEncodingException {
    ...
    static boolean isGoodChar(char chr) {
        return ((Character.getType(chr) == Character.DASH_PUNCTUATION) || (Character.isLetter(chr)) 
            || (chr == '\''));
    }
